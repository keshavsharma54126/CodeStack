...
const FullBlog = () => {
  ...
  return (
    <div className="pt-16  min-h-screen mt-40">
      <AppBar />
              ...
              <div className="flex flex-row mt-2 mb-4 gap-8">
                ...
                {isAuthor && (
                  <div className="flex flex-col gap-2  md:flex-row">
                    <button
                      className="relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all bg-cyan-500 rounded-xl group"
