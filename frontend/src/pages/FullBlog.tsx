    ...
    if (token) {
      try {
        const response = await axios.post(
          `${BACKEND_URL}/api/v1/blog/authorornot`,
          {
            id,
          },
          {
    ...
    <div className="min-h-screen mt-40">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-2  py-6 ">
          <div className="max-w-12xl mx-auto rounded-md flex flex-col lg:flex-row mt-28 lg:mt-1">
            <div className="flex-1">
              ...
              <div className="flex flex-row mt-2 mb-4 gap-8">
                <LikeDislikeButton
                  blogid={blog.id}
                  likedd={blog.postLikes[0]?.liked ?? false}
                  dislikedd={blog.postLikes[0]?.disliked ?? false}
                  like={blog.like}
                ...
                {isAuthor && (
                  <div className="flex flex-col gap-2  md:flex-row">
                    <button
                      className="relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all bg-cyan-500 rounded-xl group shadow-lg hover:bg-cyan-600"
                    ...
                    <button
                      className="relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all bg-red-500 rounded-xl group shadow-lg hover:bg-red-600"
